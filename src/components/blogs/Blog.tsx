          ...
          datas?.map((data, index: number) => (
            ...
            >
              ...
              <div className={` w-full mt-8 lg:mt-4 lg:text-left  `}>
                ...
                <Link
                  href={"/blog"}
                  className="mt-6 px-6 py-3 sm:px-8 sm:py-2 text-sm sm:text-base md:text-lg bg-transparent text-gray-800 border-gray-900 rounded-none shadow-md border transition flex justify-center items-center"
                >
                  Read More{" "}
